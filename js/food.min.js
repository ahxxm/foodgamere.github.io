            ...
            i)
                for (var n in e.chefs)
                    if (i[r] == e.chefs[n].chefId) {
                        ...
                        setDataForChef(p, o, a, e.ultimateData.global, f, e.ultimateData.self, null, !0, null, l);
...
function loadUltimate(e, a) {
    var t = getLocalData()
      , i = getUltimateData(e.chefs, t, !0, a)
      , l = i.global;
    for (var s in l)
...
function setCalConfigData(e) {
    for (var a in calCustomRule.rules) {
        ...
        for (var R in t.chefs)
            setDataForChef(t.chefs[R], null, !1, i, null, A, M, !0, t, !0)
    }
}
...
function calCustomResults(e) {
    for (var a = 0, t = 0; t < calCustomRule.rules.length; t++) {
        ...
        for (var c in l) {
            ...
            l[c].chef.chefId && setDataForChef(l[c].chef, l[c].equip, !0, i.calGlobalUltimateData, s[c], i.calSelfUltimateData, i.calActivityUltimateData, !0, i, !0)
        }
    ...
    for (var h in f)
        if (!i || f[h].got) {
            ...
            o) {
                ...
                for (var g in d)
                    d[g].chef.chefId && (r.Satiety && g != a || setDataForChef(d[g].chef, d[g].equip, !0, r.calGlobalUltimateData, v[g], r.calSelfUltimateData, r.calActivityUltimateData, !0, r, !0));
...
function getCustomDiskLevelsOptions(e, a, t) {
    ...
    for (var r = JSON.parse(JSON.stringify(l)), n = getPartialChefAdds(r, i), o = r[a].chef.disk.maxLevel, p = r[a].chef.disk.level, d = [], u = o; u > 0; u--) {
        ...
        r[a].chef.chefId && s) {
            ...
            setDataForChef(r[a].chef, r[a].equip, !0, i.calGlobalUltimateData, n[a], i.calSelfUltimateData, i.calActivityUltimateData, !0, i, !0);
    ...
    for (var m in i)
        if (i[m].type == d.type) {
            ...
            u[a].chef.chefId && n) {
                ...
                setDataForChef(u[a].chef, u[a].equip, !0, c.calGlobalUltimateData, f[a], c.calSelfUltimateData, c.calActivityUltimateData, !0, c, !0);
...
function getCustomEquipsOptions(e, a, t, i) {
    ...
    for (var u in t) {
        ...
        o[a].chef.chefId && r) {
            o[a].equip = t[u],
            setDataForChef(o[a].chef, o[a].equip, !0, s.calGlobalUltimateData, p[a], s.calSelfUltimateData, s.calActivityUltimateData, !0, s, !0);
...
function generateData(e, a, t) {
    ...
    var q = t && t.setting && t.setting.final
      ...
      , N = getUltimateData(e.chefs, t, I, R);
    i.ultimateData = N;
    var A = [];
    for (var l in e.chefs)
        if (e.chefs[l].name) {
            ...
            setDataForChef(M, M.equip, E, N.global, null, N.self, null, q, null, !0),
            A.push(M)
        }
    i.chefs = A;
    var L = [];
...
function getUltimateData(e, a, t, i) {
    var l = []
      , s = []
      , c = [];
    for (var r in e)
