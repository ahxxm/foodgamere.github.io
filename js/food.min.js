...
function initChefTable(e) {
    ...
    $.fn.dataTableExt.afnFiltering.push(function(e, a, t, i, l) {
        ...
        for (var n in s) {
            ...
            if (s[n] == "Global") {
                ...
                for (var p in r) {
                    if (r[p].condition == "Partial" && r[p].type.indexOf("BasicPriceUse") === 0) {
                        ...
                        for (var at in auraSubtypes) {
                            if (r[p].type == "BasicPriceUse" + auraSubtypes[at]) {
                                return !0;
                            }
                        }
                    }
                ...
                // 技法光环：Stirfry/Bake/Boil/Steam/Fry/Knife，condition为Partial
                var auraSubtypes = $("#chk-chef-aura-subtype").val() || [];
                var skillTypes = ["Stirfry", "Bake", "Boil", "Steam", "Fry", "Knife"];
                
                for (var p in r) {
                    if (r[p].condition == "Partial" && skillTypes.indexOf(r[p].type) !== -1) {
                        // 如果没有选择技法类型，显示所有技法光环
                        if (auraSubtypes.length == 0) {
                            return !0;
                        }
    ...
    $("#chk-chef-category").on("changed.bs.select", function() {
        ...
        // 检查是否选择了"售价光环"或"技法光环"
        if (selectedValues.indexOf("PriceAura") !== -1 || selectedValues.indexOf("SkillAura") !== -1) {
